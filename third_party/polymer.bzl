...
def tensorboard_polymer_workspace():
  ...
  web_library_external(
      ...
      licenses = ["notice"],  # BSD-3-Clause
      sha256 = "be9beddca4cbdb47ba014e009cf2825414baf956d9d2c2d9d2142224ad302076",
      urls = [
          "https://mirror.bazel.build/github.com/webcomponents/shadycss/archive/v1.9.0.tar.gz",
          "https://github.com/webcomponents/shadycss/archive/v1.9.0.tar.gz",
      ],
      strip_prefix = "shadycss-1.9.0",
      path = "/shadycss",
      srcs = [
          "apply-shim.html",
          "apply-shim.min.js",
